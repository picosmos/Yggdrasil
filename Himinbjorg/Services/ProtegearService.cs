...
public class ProtegearService(ILogger<ProtegearService> logger, CachedRequestService cachedRequestService)
{
    ...
    public string Request(string imei, string apiSecret, DateTime from, DateTime to)
    {
        ...
        {
            this._logger.LogInformation($"Returning cached response for {apiUrl}");
